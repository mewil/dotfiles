# spectrum copied from http://github.com/sykora/etc/blob/master/zsh/functions/spectrum/
typeset -Ag FX FG BG
...
function PR_DIR() {
    ...
    echo "%{$fg[green]%}${truncated}%{$fg[blue]%}%B${last}%b%{$reset_color%}"
}
...
if [[ "$(tput colors)" == "256" ]]; then
    ...
    ZSH_HIGHLIGHT_STYLES[alias]=fg=048,bold
    ZSH_HIGHLIGHT_STYLES[builtin]=fg=048,bold
    ZSH_HIGHLIGHT_STYLES[function]=fg=048,bold
    ZSH_HIGHLIGHT_STYLES[command]=fg=048,bold
    ZSH_HIGHLIGHT_STYLES[precommand]=fg=048,underline
    ZSH_HIGHLIGHT_STYLES[commandseparator]=none
    ZSH_HIGHLIGHT_STYLES[hashed-command]=fg=037
    ZSH_HIGHLIGHT_STYLES[path]=fg=134,underline
    ...
    ZSH_HIGHLIGHT_STYLES[single-quoted-argument]=fg=134
    ZSH_HIGHLIGHT_STYLES[double-quoted-argument]=fg=134
    ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]=fg=134
    ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]=fg=134
